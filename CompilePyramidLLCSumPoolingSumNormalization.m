function [ pyramid_all ] = CompilePyramidLLCSumPoolingSumNormalization( imageFileList, dataBaseDir, textonSuffix, params, canSkip, pfig )
...
for f = 1:length(imageFileList)
    ...
    for i=1:binsHigh
        for j=1:binsHigh
            ...
            pyramid_cell{1}(i,j,:) = sum(texton_patch)./sum(sum(texton_patch));
        end
    end
