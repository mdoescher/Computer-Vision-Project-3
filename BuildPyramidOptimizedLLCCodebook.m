...
%% build the pyramid
BuildLLCCodebook(imageFileList,imageBaseDir,dataBaseDir,params,canSkip,pfig);
BuildHistogramsLLC(imageFileList,imageBaseDir,dataBaseDir,'_sift.mat',params,canSkip,pfig);
pyramid_all = CompilePyramidLLCMaxPoolingL2Normalization(imageFileList,dataBaseDir,sprintf('_texton_ind_%d.mat',params.dictionarySize),params,canSkip,pfig);
close(pfig);
end
